...
class PTWRouteReplacemnt {
  ...
  factory PTWRouteReplacemnt.fromMap(Map<String, dynamic> map) {
  ...
  factory PTWRouteReplacemnt.fromJson(String source) =>
      PTWRouteReplacemnt.fromMap(json.decode(source));

  @override
  String toString() =>
      'PTWRouteReplacemnt(id: $id, name: $name, state: $state,fromDatetime: $fromDatetime, toDatetime: $toDatetime,replaceableOldRouteIdsTxt: $replaceableOldRouteIdsTxt, driverId: $driverId,vehicleId: $vehicleId, companyID: $companyID,branchID: $branchID, planTripProductId: $planTripProductId,planTripWaybillId: $planTripWaybillId, newRouteIDs: $newRouteIDs)';

  @override
  bool operator ==(Object o) {
    if (identical(this, o)) return true;

    return o is PTWRouteReplacemnt &&
        o.id == id &&
        o.name == name &&
        o.state == state &&
