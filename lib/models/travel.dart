...
class Leave {
  ...
  @override
  String toString() => 'Leave(start_date: $start_date, end_date: $end_date, city_from: $city_from, city_to: $city_to)';
  ...
  @override
  int get hashCode => start_date.hashCode ^ end_date.hashCode ^ city_from.hashCode ^ city_to.hashCode;
}
